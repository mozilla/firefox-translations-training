...
Data cleaning | Basic preprocessing, language specific, rule based, deduplication, [bicleaner](https://github.com/bitextor/bicleaner) and other attempts to clean noisy data | CPU | Good parallelization across CPU cores. To make cleaning of a new language more efficient add it to [clean_parallel.py](/pipeline/clean/clean_parallel.py).
