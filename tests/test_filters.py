...
from pipeline.clean.opuscleaner.generate_filters import generate
...
@pytest.mark.parametrize(
    ...
    [
        # very defaults
        ("en", "ru", "mtdata_Tilde-airbaltic-1-eng-rus", "default.filters.json"),
        ("fr", "en", "mtdata_Tilde-airbaltic-1-eng-rus", "default.filters.json"),
        ("fr", "en", "opus_ELRC-3075-wikipedia_health/v1", "default.filters.json"),
        ...
        ("ru", "en", "opus_UNPC/v1.0", "opus_UNPC-v1.0.filters.json"),
        ("fr", "en", "opus_UNPC/v1.0", "opus_UNPC-v1.0.filters.json"),
    ],
    ids=[
        "default-en-ru",
        "default-fr-en",
...
def test_generate_filters(params, data_dir):
    ...
    """
    src, trg, dataset, config_path = params
    ...
    generate(dataset=dataset, output=output_path, src=src, trg=trg)
